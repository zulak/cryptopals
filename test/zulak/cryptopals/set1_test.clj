(ns zulak.cryptopals.set1-test
  (:require [clojure.test :refer :all]
            [clojure.string :as s]
            [clojure.java.io :as io]
            [zulak.cryptopals.common :refer :all]
            [zulak.cryptopals.set1 :refer :all]))
...
(deftest test-challenge-1
  (let [input "49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d"
        input-bytes (hex->bytes input)
        output "SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t"]
    (testing "java8 b64 encoder"
      (is (= output (challenge-1 input-bytes))))))
...
(deftest test-challenge-2
  (let [input (hex->bytes "1c0111001f010100061a024b53535009181c")
    ...
    (testing "single-xor encryption"
      (is (= output (bytes->hex (challenge-2 input key)))))))
